  ...
  return (
    <div className='form'>
      <form onSubmit={formType === 'drink' ? handlePostRequest : handlePutRequest}>
        ...
        <br/>
          <label htmlFor="image">Link to an image of the drink:</label>
          <input type="text" id="image" onChange={(ev) => setImage(ev.target.value)}/>
        
        <input id='submit' type="submit" />
        
      </form>
      
      <img src='https://matthewgilson.files.wordpress.com/2013/02/colepours.gif' alt='drink' className='mixingPhoto'></img>
    </div>
  )
}
